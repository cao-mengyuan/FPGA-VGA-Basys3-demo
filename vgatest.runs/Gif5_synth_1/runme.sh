...
HD_PWD='E:/vivado_files/vgatest/vgatest.runs/Gif5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gif5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gif5.tcl
