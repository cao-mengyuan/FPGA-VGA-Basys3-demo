...
HD_PWD='E:/vivado_files/vgatest/vgatest.runs/number0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log number0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source number0.tcl
