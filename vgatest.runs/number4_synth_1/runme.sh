...
HD_PWD='E:/vivado_files/vgatest/vgatest.runs/number4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log number4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source number4.tcl
