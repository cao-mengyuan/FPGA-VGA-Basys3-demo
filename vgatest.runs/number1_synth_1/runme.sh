...
HD_PWD='E:/vivado_files/vgatest/vgatest.runs/number1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log number1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source number1.tcl
