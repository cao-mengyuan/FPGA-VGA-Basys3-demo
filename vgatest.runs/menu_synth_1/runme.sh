...
HD_PWD='E:/vivado_files/vgatest/vgatest.runs/menu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log menu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source menu.tcl
