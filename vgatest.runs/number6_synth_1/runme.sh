...
HD_PWD='E:/vivado_files/vgatest/vgatest.runs/number6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log number6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source number6.tcl
