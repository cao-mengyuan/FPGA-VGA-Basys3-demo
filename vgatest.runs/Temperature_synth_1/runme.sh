...
HD_PWD='E:/vivado_files/vgatest/vgatest.runs/Temperature_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Temperature.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Temperature.tcl
