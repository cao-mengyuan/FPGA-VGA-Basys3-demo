...
#
# Generated by export_simulation on Thu May 26 13:03:14 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number4.sh' script.

./number4.sh -reset_run
...
./number4.sh -noclean_files

For more information on the script, please type './number4.sh -help'.
