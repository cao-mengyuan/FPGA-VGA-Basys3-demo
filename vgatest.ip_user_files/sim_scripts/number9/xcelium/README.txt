...
#
# Generated by export_simulation on Thu May 26 13:30:54 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number9.sh' script.

./number9.sh -reset_run
...
./number9.sh -noclean_files

For more information on the script, please type './number9.sh -help'.
