...
#
# Generated by export_simulation on Thu May 26 14:08:32 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number5.sh' script.

./number5.sh -reset_run
...
./number5.sh -noclean_files

For more information on the script, please type './number5.sh -help'.
