...
#
# Generated by export_simulation on Thu May 26 14:06:20 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number2.sh' script.

./number2.sh -reset_run
...
./number2.sh -noclean_files

For more information on the script, please type './number2.sh -help'.
