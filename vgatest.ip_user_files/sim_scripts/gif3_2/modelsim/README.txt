...
#
# Generated by export_simulation on Wed Jun 08 11:59:05 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './gif3.sh' script.
...
./gif3.sh -noclean_files

For more information on the script, please type './gif3.sh -help'.
