...
#
# Generated by export_simulation on Thu May 26 16:33:34 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number1.sh' script.

./number1.sh -reset_run
...
./number1.sh -noclean_files

For more information on the script, please type './number1.sh -help'.
