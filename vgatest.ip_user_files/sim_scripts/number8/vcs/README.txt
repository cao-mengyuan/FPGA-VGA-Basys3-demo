...
#
# Generated by export_simulation on Thu May 26 14:12:10 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number8.sh' script.

./number8.sh -reset_run
...
./number8.sh -noclean_files

For more information on the script, please type './number8.sh -help'.
