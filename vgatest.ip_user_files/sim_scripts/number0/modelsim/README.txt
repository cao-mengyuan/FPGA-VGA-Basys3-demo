...
#
# Generated by export_simulation on Thu May 26 14:12:53 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number0.sh' script.

./number0.sh -reset_run
...
./number0.sh -noclean_files

For more information on the script, please type './number0.sh -help'.
