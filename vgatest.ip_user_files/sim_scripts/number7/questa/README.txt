...
#
# Generated by export_simulation on Thu May 26 14:11:27 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number7.sh' script.

./number7.sh -reset_run
...
./number7.sh -noclean_files

For more information on the script, please type './number7.sh -help'.
