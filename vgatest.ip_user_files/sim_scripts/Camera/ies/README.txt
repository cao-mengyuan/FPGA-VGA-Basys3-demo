...
#
# Generated by export_simulation on Wed Jun 01 12:29:58 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './Camera.sh' script.
...
./Camera.sh -noclean_files

For more information on the script, please type './Camera.sh -help'.
