...
#
# Generated by export_simulation on Thu May 26 14:07:02 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number3.sh' script.

./number3.sh -reset_run
...
./number3.sh -noclean_files

For more information on the script, please type './number3.sh -help'.
