...
#
# Generated by export_simulation on Thu May 26 14:09:35 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './number6.sh' script.

./number6.sh -reset_run
...
./number6.sh -noclean_files

For more information on the script, please type './number6.sh -help'.
